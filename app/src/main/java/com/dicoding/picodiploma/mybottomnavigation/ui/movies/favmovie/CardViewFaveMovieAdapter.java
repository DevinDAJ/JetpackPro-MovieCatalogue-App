...
public class CardViewFaveMovieAdapter extends RecyclerView.Adapter<CardViewFaveMovieAdapter.CardViewViewHolder> {
    ...
    public void setListMovies(List<MovieEntity> mListMovies) {
        this.listMovies = mListMovies;
        notifyDataSetChanged();
    }

    public CardViewFaveMovieAdapter(Context context) {
