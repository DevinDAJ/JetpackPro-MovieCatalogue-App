...
public class CardViewFaveShowAdapter extends RecyclerView.Adapter<CardViewFaveShowAdapter.CardViewViewHolder> {
    private Context context;
    private List<TVShowEntity> listShows;
    private List<TVShowEntity> getListShows() {
        return listShows;
    }

    public void setListShows(List<TVShowEntity> listShows) {
        this.listShows = listShows;
    }

    public CardViewFaveShowAdapter(Context context) {
